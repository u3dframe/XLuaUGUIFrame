...
/// 功能 : 
/// </summary>
public class CurveEx : MonoBehaviour
{
    static public CurveEx GetInChild(GameObject gobj)
    {
        if (gobj)
        {
    ...
    [SerializeField] AnimationCurve[] m_curves1; // 对应 x
    [SerializeField] AnimationCurve[] m_curves2; // 对应 y
    [SerializeField] AnimationCurve[] m_curves3; // 对应 z
