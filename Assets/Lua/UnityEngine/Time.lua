...
function Time:SetFixedDelta(fixedDeltaTime,fixedUnscaledDeltaTime)	
	_Time.fixedDeltaTime = fixedDeltaTime
	_Time.fixedUnscaledDeltaTime = fixedUnscaledDeltaTime

	_Time.fixedTime = _Time.fixedTime + fixedDeltaTime
	_Time.fixedUnscaledTime = _Time.fixedUnscaledTime + fixedUnscaledDeltaTime
end
